...
<head>
    <meta charset="utf-8" />
    <title>Edit Biodata Quintessence</title>
    ...
    <form action="" method="post">
        <div class="m-lg-5">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" id="Nama" placeholder="Masukan Nama Lengkap" name="nama" value="<?= $biodata['nama_lengkap'] ?>" required/>
            </div>
            ...
            <div class="mb-3">
                <label for="T-badan" class="form-label">Alamat</label>
                <input class="form-control" type="text" id="alamat" placeholder="Contoh: 180" name="alamat" value="<?= $biodata['alamat'] ?>" required/>
            </div>
