...
<head>
    <meta charset="utf-8" />
    <title>Data Hiv Quintessence</title>
...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="data-hiv.php" class="dropdown-item active">Hiv</a>
                    </div>
                </div>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header-aborsi">
        ...
        <table class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    <th>NO</th>
                    <th>Provinsi</th>
                    <th>Jumlah Pengidap HIV</th>
                </tr>
            <tbody>
                <?php
                include "koneksi.php";
                $query = mysqli_query($conn, "select t_provinsi.provinsi, t_hiv.jumlah_hiv from t_hiv inner join t_provinsi on t_hiv.id_provinsi =t_provinsi.id_provinsi order by t_hiv.jumlah_hiv desc");
                $no = 1;
