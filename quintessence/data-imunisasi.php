...
<head>
    <meta charset="utf-8" />
    <title>Data Imunisasi Quintessence</title>
...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="data-imunisasi.php" class="dropdown-item active">Imunisasi</a>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header-imunisasi">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <a href="">
                        <h1 class="display-3 text-white animated slideInDown">
                            Data Imunisasi Tiap Provinsi
                        </h1>
                    </a>
                </div>
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                include "koneksi.php";
                $query = mysqli_query($conn, "select t_provinsi.provinsi, t_imunisasi.persentase_imunisasi, t_imunisasi.jumlah_balita from t_imunisasi inner join t_provinsi on t_imunisasi.id_provinsi =t_provinsi.id_provinsi order by CAST(persentase_imunisasi AS UNSIGNED) desc");
                $no = 1;
