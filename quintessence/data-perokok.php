...
<head>
    <meta charset="utf-8" />
    <title>Data Perokok Aktif Quintessence</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0" id="home">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="login.php" class="nav-item nav-link">Medical Check-up</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Data Provinsi</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="data-perokok.php" class="dropdown-item active">Perokok aktif</a>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header-perokok">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <a href="">
                        <h1 class="display-3 text-white animated slideInDown">
                            Data Perokok Aktif Tiap Provinsi
                        </h1>
                    </a>
                </div>
            </div>
                ...
                <div class="col-md-8 offset-md-2">
                    <form action="">
                        <div class="input-group">
                            <input type="search" id="searchInput" class="form-control form-control-lg" placeholder="Yukk dicari">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                include "koneksi.php";
                $query = mysqli_query($conn, "SELECT t_provinsi.provinsi, t_perokok.persentase_perokok FROM t_perokok INNER JOIN t_provinsi ON t_perokok.id_provinsi = t_provinsi.id_provinsi ORDER BY persentase_perokok DESC");
                $no = 1;
