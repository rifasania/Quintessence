...
<head>
    <meta charset="utf-8" />
    <title>Data Nakes Quintessence</title>
...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="data-distribusi.php" class="dropdown-item active">Distribusi Tenaga Kerja</a>
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-primary py-5 mb-5 page-header-distribusi">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <a href="#">
                        <h1 class="display-3 text-white animated slideInDown">
                            Data Distribusi Tenaga Kerja Kesehatan Tiap Provinsi
                        </h1>
                    </a>
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    <th>NO</th>
                    <th>Provinsi</th>
                    <th>Jumlah Nakes Tiap Provinsi</th>
                    <th>Jumlah Rumah Sakit</th>
                </tr>
            <tbody>
                <?php
                include "koneksi.php";
                $query = mysqli_query($conn, "select t_provinsi.provinsi, t_nakes.jumlah_nakes, t_nakes.jumlah_rs from t_nakes inner join t_provinsi on t_nakes.id_provinsi =t_provinsi.id_provinsi order by t_nakes.jumlah_nakes desc");
                $no = 1;
